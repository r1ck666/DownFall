...
struct  AvatarIKGoal_t3089653344 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AvatarIKGoal_t3089653344, ___value___1)); }
