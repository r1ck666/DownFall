...
#include "UnityEngine_UnityEngine_AvatarIKGoal3089653344MethodDeclarations.h"
...
IL_0020:
	{
		...
		NullCheck(_stringLiteral371857150);
...
IL_0014:
	{
		...
		NullCheck((*((GUIStyle_t1799908754 **)L_4)));
...
IL_029d:
	...
	}
	{
		...
		int32_t L_129 = V_12;
		G_B33_0 = L_127;
		G_B33_1 = (*(Rect_t3681755626 *)((L_122)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_123))));
		G_B33_2 = L_121;
		if ((!(((uint32_t)L_128) == ((uint32_t)L_129))))
		{
			G_B39_0 = L_127;
			G_B39_1 = (*(Rect_t3681755626 *)((L_122)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_123))));
			G_B39_2 = L_121;
			goto IL_02f0;
		}
	}
...
IL_031e:
	...
	}
	{
		...
		int32_t L_154 = V_12;
		G_B50_0 = L_152;
		G_B50_1 = (*(Rect_t3681755626 *)((L_147)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_148))));
		G_B50_2 = L_146;
		if ((!(((uint32_t)L_153) == ((uint32_t)L_154))))
		{
			G_B56_0 = L_152;
			G_B56_1 = (*(Rect_t3681755626 *)((L_147)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_148))));
			G_B56_2 = L_146;
			goto IL_037c;
		}
	}
...
IL_004d:
	{
		...
		int32_t L_10 = V_4;
		NullCheck(L_9);
		V_5 = (*(Rect_t3681755626 *)((L_9)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_10))));
...
{
	{
		__this->set_apply_4((bool)0);
		__this->set_hasScrollTo_5((bool)0);
		Object__ctor_m2551263788(__this, /*hidden argument*/NULL);
		return;
	}
}
